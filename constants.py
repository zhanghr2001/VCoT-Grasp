...
grasp_anything_planar_grasp_train_csv_path = "/baishuanghao/GraspLLM/split/grasp_anything_match/train.csv"
grasp_anything_planar_grasp_test_seen_csv_path = "/baishuanghao/GraspLLM/split/grasp_anything_match/test_seen.csv"
grasp_anything_planar_grasp_test_unseen_csv_path = "/baishuanghao/GraspLLM/split/grasp_anything_match/test_unseen.csv"
